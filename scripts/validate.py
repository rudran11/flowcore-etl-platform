...
def validate_repository_structure():
    required_paths = [
        ...
        "packages/shared/flowcore_shared/schemas/dependencies",
        "packages/shared/flowcore_shared/schemas/operational",
        ...
        "packages/server/flowcore_server",
        "packages/server/flowcore_server/api",
        "packages/server/flowcore_server/api/v1",
        "packages/server/flowcore_server/exceptions",
        "packages/server/tests",
        "packages/server/tests/api",
