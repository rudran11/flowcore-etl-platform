...
from flowcore_server.db.base import get_session
from flowcore_server.db.models import Workspace, Pipeline, PipelineVersion
...
async def main():
    ...
    async for session in get_session():
        ...
        run = await exec_service.start_execution(str(p.id), str(v.id), "API", {}, None)
